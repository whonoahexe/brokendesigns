  ...
  return (
    <div className="container w-full max-w-[98%] md:max-w-[92%] px-6 md:px-12 mx-auto mt-40 md:mt-52">
      <div className="w-full aspect-video bg-black-tertiary rounded-[22px] mt-16">
          <iframe width="full" height="full" src={card?.url} title="YouTube video player" frameBorder={0} allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen className="w-full aspect-video rounded-[22px]" />
      </div>
