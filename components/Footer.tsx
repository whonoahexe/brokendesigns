  ...
  return (
    <footer className="flex flex-col lg:flex-row gap-12 md:gap-6 lg:gap-0 justify-between items-center container w-full max-w-[92%] px-12 py-24 mx-auto">
      <Link
        ...
        className="font-display flex items-center gap-2 text-4xl text-white hover:text-[#c4c6d0] transition-all duration-150 ease-in-out-def"
      >
      ...
      <div className="flex gap-12 text-white underline underline-offset-2">
        <Link
          ...
          target="_blank"
          className="hover:text-[#c4c6d0] transition-all duration-150 ease-in-out-def"
        >
          Twitter
        </Link>
        <Link
        ...
        <Link
          href="https://github.com/TheNoah13XD"
          target="_blank"
          className="hover:text-[#c4c6d0] transition-all duration-150 ease-in-out-def"
        >
          Github
